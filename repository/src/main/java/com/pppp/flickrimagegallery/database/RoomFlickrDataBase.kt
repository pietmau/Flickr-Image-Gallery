...
internal abstract class RoomFlickrDataBase : RoomDatabase(), FlickrDatabase<RoomFlickrImage> {
    abstract fun dao(): FlickrDao

    override fun insert(images: List<RoomFlickrImage>) = dao().insert(images)
}
